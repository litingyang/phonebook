...
int main(void)
{
    ...
    fprintf(output, "append() %.lf %lf %lf %lf\n",orig_sum_a / 100.0, opt_sum_a / 100.0, hash_sum_a / 100, trie_sum_a / 100);
    fprintf(output, "findName() %lf %lf %lf %lf", orig_sum_f / 100.0, opt_sum_f / 100.0, hash_sum_f / 100, trie_sum_f / 100);
    fclose(output);
    fclose(fp);
    return 0;
}
